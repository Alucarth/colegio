    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class='glyphicon  glyphicon-floppy-saved'></i> Actualizar Datos del Alumno</h4>
            </div>
            <div class="modal-body">
            <form class="steps-modelos" id="form-modelos" method="post">
              <input type="hidden" name="mod_cod" value="Actualizar" />
              <input type="hidden" name="id_usuario" id="id_usuario" />
              <input type="hidden" name="edad" id="resultados_edit" />
              ...
              <div class="row">
                  ...
                  <div class="col-md-4">
                      ...
                      <div class="form-group">
                          <label>Fecha de Nacimiento: <span class="text-warning">(Registrado)</span></label>
                          <input type="text" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control required" disabled>
                      </div>                                        
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                            <input type="text" id="ano_edit" name="ano_edit" class="form-control" placeholder="Año" onKeyUp="edit_edad()"></div>
                        </div><br /> <br />                      
                      <div class="form-group">
                  ...
                  <div class="col-md-4">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" id="resultado_edit" name="resultado_edit" class="form-control required" disabled>
                      </div>                                        
...
function edit_edad(){
 var fecha_ini = Number(document.getElementById("ano_edit").value);
 var fecha = <?php echo date('Y'); ?>;
 document.getElementById("resultado_edit").value = fecha - fecha_ini;
  document.getElementById("resultados_edit").value = fecha - fecha_ini;
}
</script>