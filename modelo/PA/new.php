    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class='glyphicon  glyphicon-floppy-saved'></i> Nuevo Personal</h4>
            </div>
...
<form class="steps-mod" id="form-mod" method="post" enctype="multipart/form-data">
  ...
  <div class="row">
      ...
      <div class="col-md-4">
          ...
          <div class="form-group">
              <label>Nivel de usuario: <span class="text-danger">(Requerido)</span></label>
