...
$db = new MySQL(); 
$i=0;
$paralelo = $db->consulta("select * from usuario");
...
$pdf->SetFontSize(14);
$pdf->Cell(0,0,'Lista de Plantel Administrativo',0,1,'C');		
$pdf->Ln(10);
			$pdf->SetTextColor(0);
			...
			$pdf->Row(array('N','Carnet de Identidad','Nombre de alumnos','Cargo','Estado'));
			$n=1;
			for($j=0;$j<$i;$j++)
			{
