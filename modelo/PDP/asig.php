    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class='glyphicon  glyphicon-floppy-saved'></i> Nuevo Docente de Primaria</h4>
            </div>
            <div class="modal-body">
<form class="steps-validations" id="form-perfils" method="post" enctype="multipart/form-data">
  ...
  <div class="row">
      <div class="col-md-4">
          ...
          <div class="form-group">
            <label>Primera Materia: <span class="text-danger">(Requerido)</span></label>
            <input type="text" id="materia"  name="materia" class="form-control required" placeholder="Materia que dicta" >
          </div>                                                                    
      </div>               
      <div class="col-md-4">
          <div class="form-group">
      ...
      <div class="col-md-4"> 
        ...
        <div class="content-divider"> 
						...
						if(!empty($foto)){
						 ...
						 echo"<img src='".server_url."userfiles/img/face3.png' class='img-rounded img-preview'>";}
						?>                                     
        </div>                        
  ...
  <fieldset>
    ...
    <div class="alert alert-info alert-styled-left alert-arrow-left alert-warning">
        ...
        El LOGIN Y CONTRASEÑA, del docente escrito sera: <br />LOGIN: PRIMER APELLIDO PATERNO Y CONTRASEÑA: NUMERO CARNET<br />
