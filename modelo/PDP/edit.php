    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class='glyphicon  glyphicon-wrench'></i> Editar datos de Docente</h4>
            </div>
            <div class="modal-body">
<form class="steps-modelos" id="form-modelos" method="post" enctype="multipart/form-data">
  ...
  <div class="row">
      ...
      <div class="col-md-4"> 
        ...
        <div class="content-divider"> 
                        <?php 
						if(!empty($dt_01["foto"])){
						 echo"<img src='".server_url.$carpeta.$dt_01["id"].".".$dt_01["foto"]."' class='img-rounded img-preview'>";}
						else{
