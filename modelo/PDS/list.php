<?php 
	...
	$tabla_0=$base->prefig."docente_aula_s";	
	...
	if (!$user->check_register()){
     ...
     if($_POST["mod_cod"]=="guardar"){
	  ...
	  nota_3,nota_4,modificacion)value('','S','3','','{$_POST['nombre']}','{$_POST['ap_paterno']}','{$_POST['ap_materno']}','{$_POST['carnet']}',
...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">Plantel Docente del Nivel Secundario</h5>
        <div class="heading-elements">
            <ul class="icons-list">
                ...
                <li><a class="btn bg-brown" href="<?php echo server_url.$modelos."imprimir.php"?>" target="_blank" style="color: #f3f4f4;"><i class="icon-printer position-left"></i>Imprimir</a></li>                 
      ...
      <tr>
          ...
          <td>
            ...
            if(!empty($dt_01["foto"])){
             ...
             echo"<img src='".server_url."userfiles/user_docente_s/face.png' class='img-xs'>";}
            ?>           
