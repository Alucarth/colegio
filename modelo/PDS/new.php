<!-- Basic modal -->
<div id="modal_news" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" id="myModalLabel"><i class='glyphicon  glyphicon-floppy-saved'></i> Nuevo Docente de Secundaria</h4>
            </div>
            <div class="modal-body">
<form class="steps-mod" id="form-mod" method="post" enctype="multipart/form-data">
